            ...
            <div className="flex-1 flex flex-col h-full relative min-w-0">
                <header className="h-24 flex-none flex items-center justify-between px-10 relative z-[50] border-b border-border bg-background/20 backdrop-blur-md">
                    ...
                    <div className="flex items-center gap-4">
                        <ThemeToggle />
                        <button className="h-10 w-10 rounded-2xl flex items-center justify-center text-foreground/60 hover:text-magic-purple transition-all border border-border hover:bg-accent relative">
                            <Bell size={18} />
                ...
                <main className="flex-1 overflow-hidden relative">
                    ...
                    <div className="absolute inset-y-0 left-0 w-20 pointer-events-none bg-gradient-to-r dark:from-black/40 from-black/5 to-transparent z-20" />
                </main>
            </div>
        </div>
    );
