...
export function ThemeToggle() {
    ...
    return (
        <button
            ...
            className="h-10 w-10 rounded-full flex items-center justify-center text-foreground/60 hover:text-primary transition-all border border-border hover:bg-accent relative group"
            title="Toggle Theme"
        >
            {theme === 'dark' ? (
