...
export default function ObstacleToolbox({ wallIndex }: ObstacleToolboxProps) {
    ...
    return (
        <aside className="w-72 glass-brilliant glass-shine rounded-[2rem] p-6 flex flex-col gap-6 h-full border border-white/5 shadow-2xl">
            {/* Header / Versioning */}
            <div className="flex flex-col gap-1 relative z-10">
                <span className="text-[10px] font-black text-magic-purple uppercase tracking-[0.3em]">
                    Hardware_Library
                </span>
                <span className="text-[11px] font-medium text-white/30 font-mono italic">
                    v4.1_UNIFIED_SLICE
                </span>
            </div>
