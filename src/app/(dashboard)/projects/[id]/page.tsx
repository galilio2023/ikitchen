...
export default function ProjectDetailsPage() {
    ...
    return (
        <div ref={pageRef} className="h-full flex flex-col overflow-hidden bg-transparent">
            ...
            {project && (
                /* FIXED: Adjusted padding for mobile (p-4) vs desktop (md:p-8) */
                <div className="flex-1 flex flex-col overflow-hidden p-4 md:p-8 lg:p-10 pt-4">
                    ...
                    <div className="flex-1 flex flex-col lg:flex-row gap-6 min-h-0 overflow-y-auto lg:overflow-hidden scrollbar-hide">
                        ...
                        <section className="flex-[4] flex flex-col min-h-[400px] md:min-h-0 space-y-2 animate-reveal">
                            ...
                            {/* FIXED: Responsive border radius */}
